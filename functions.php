...
function leravio_file()
{
  ...
  wp_enqueue_style('leravio_main_styles', get_theme_file_uri('/assets/css/style.css'), NULL, '1.2');
  ...
  wp_enqueue_script('cookie-js', '//cdnjs.cloudflare.com/ajax/libs/js-cookie/3.0.1/js.cookie.min.js', NULL, '3.0.1', true);
  wp_enqueue_script('slick-js', '//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js', NULL, '1.8.1', true);
  wp_enqueue_script('main-leravio-js', get_theme_file_uri('/assets/js/app.js'), NULL, '1.2', true);
}
